...
public class DashboardController {
    ...
    private void handleLogout() {
        switchScene("/com/hcmuss/admin/fxml/login.fxml", "Login", 800, 600);
    }
    ...
    private void switchToLogin() {
        try {
            FXMLLoader fxmlLoaderLogin = new FXMLLoader(getClass().getResource("/com/hcmuss/admin/fxml/login.fxml"));
    ...
    private void loadPage(String page) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/hcmuss/admin/fxml/" + page + ".fxml"));
            root.getStylesheets()
                    .add(getClass().getResource("/com/hcmuss/admin/css/" + page + ".css").toExternalForm());
            bp.setCenter(root);
        } catch (IOException e) {
