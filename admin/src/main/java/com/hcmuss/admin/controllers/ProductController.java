...
import com.hcmuss.admin.models.product.ProductResponse;
...
public class ProductController {
    ...
    private void handleDeleteUser(ProductResponse product) {
        ...
        String url = BaseUrl + "/api/v1/product/" + product.getId();
    ...
    private void switchToDashboard() {
        try {
            ...
            FXMLLoader fxmlAddNews = new FXMLLoader(
                    getClass().getResource("/com/hcmuss/admin/fxml/product_add.fxml"));
    ...
    public void getProducts() {
        ...
        String url = BaseUrl + "/api/v1/product";
