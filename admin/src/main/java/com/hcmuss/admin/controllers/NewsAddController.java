...
import com.hcmuss.admin.models.NewCategory;
...
public class NewsAddController {
    ...
    public void saveNews() {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(new URI(BaseUrl + "/api/v1/new"))
    ...
    private void fetchCategoriesFromApi() {
        ...
        String url = BaseUrl + "/api/v1/news-category";
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(url))
                .build();
                ...
                Platform.runLater(() -> {
                    if (httpResponse.statusCode() == 200) {
                        try {
                            ...
                            categoryComboBox.setCellFactory(_ -> new ListCell<>() {
                                @Override
