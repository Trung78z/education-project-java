...
export default function Card({ color = "white" }: { color: string }) {
  return (
    <div
      className={clsx(
        `relative rounded-sm border pb-4 hover:shadow-md`,
        color === "black" && "bg-black text-white",
      )}
    >
      <div className="bg-background absolute right-4 top-4 rounded-full p-2">
        <svg
        ...
        <div className="space-y-1 px-6">
          ...
          <ul className="flex items-center justify-center gap-x-8 rounded-sm border px-2 py-4">
            <li className="flex flex-col items-center gap-x-1">
              <img src="assets\images\product\S.svg" alt="" />
              <span className="text-xs">20 Miles</span>
            </li>
            <li className="flex flex-col items-center gap-x-1">
              <img src="assets\images\product\fuel.svg" alt="" />{" "}
              <span className="text-xs">20 Miles</span>
            </li>
            <li className="flex flex-col items-center gap-x-1">
              <img src="assets\images\product\hopso.svg" alt="" />{" "}
              <span className="text-xs">20 Miles</span>
            </li>
          </ul>
          <div className="flex items-center justify-between px-4">
            ...
            <Button type="link">
              View details{" "}
              <span>
                <img src="public\assets\icons\dedot.svg" alt="" />
              </span>{" "}
            </Button>
          </div>
        </div>
